...
export default function Dashboard() {
    ...
    useEffect(() => {
        const handleGetAllAwebsite = async () => {
            setLoading(true)
            try {
        ...
        <div className='min-h-screen bg-[#050505] text-white'>
            <div className='sticky top-0 z-40 backdrop-blur-xl bg-black/50 border-b border-white/10'>
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between '>
                    ...
                    <button className='px-4 py-2 rounded-lg bg-white text-black text-sm font-semibold 
             hover:scale-105 transition' onClick={() => navigate('/generate')}>
                        + New Website
                    </button>
                </div>
            </div>
            <div className='max-w-7xl mx-auto px-6 py-10'>
                ...
                {loading && (
                    <div className='mt-24 text-center text-red-400'>Loading your Websites...</div>
                )}
                        ...
                        {websites?.map((w, i) => {
                            ...
                            return <motion.div
                                ...
                                <div className='p-5 flex flex-col gap-4 flex-1'>
                                   ...
                                   bg-gradient-to-r from-indigo-500 to-purple-500 hover:scale-105 transition'
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                handleDeploy(w._id)}}
                                        ...
                                        (<motion.button
                                            ...
                                            onClick={(e) => {  
                                                e.stopPropagation();
                                                handleCopy(w)}}
                                            className={`mt-auto flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm font-medium 
                                        transition-all 

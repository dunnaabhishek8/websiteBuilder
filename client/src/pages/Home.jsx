      ...
      <motion.div
        ...
        <div className='max-w-7xl mx-auto px-6 py-4 flex justify-between items-center'>
          ...
          <div className='flex items-center gap-5'>
            ...
            {!userData ? <button className='px-4 py-2 rounded-lg border border-white/20 hover:bg-white/10 text-sm' onClick={() =>
              setOpenLogin(true)}>
              Get Started
            </button> :
              <div className='relative'>
                <button className='flex items-center' onClick={() => setOpenProfile(!openProfile)}>
                  <img src={userData.avatar || `https://ui-avatars.com/api/?name=${userData.name}`}
                    referrerPolicy='no-ref' className='w-9 h-9 rounded-full border border-white/20 object-cover' />
                </button>
            ...
            {highlights.map((h, i) => (
              ...
              >
                ...
                <p className='text-sm text-zinc-400'>
                  ...
                  animations, responsivness and scalable structure.
                </p>
              </motion.div>
            ))}
          </div>
        ...
        {websites?.map((w, i) => {
          ...
          >
            ...
            <div className='p-1 mt-4'>
              <h3 className='text-base font-semibold line-clamp-2 mb-2 max-w-[85%]'>{w.title}</h3>
